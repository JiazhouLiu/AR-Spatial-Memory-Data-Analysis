...
##################################################
######### Locomotion by Furniture (Learning) #######################
...
data.locomotion.furniture.learning <- data.frame( 
  PID = 1:16,
...
data.locomotion.furniture.learning$PID=as.factor(data.locomotion.furniture.learning$PID)
data.locomotion.furniture.learning$Furniture=as.factor(data.locomotion.furniture.learning$Furniture)


setwd("~/R Projects/ARSpatialMemory-R")
save(data.locomotion.furniture.learning, file = "data.locomotion.furniture.learning.Rdata")

##################################################
######### Locomotion by Furniture (Recall) #######################
setwd("~/R Projects/ARSpatialMemory-R/Data/positionData")
WDFiles = list.files(pattern="*Raw.csv")
for(pNum in 1:length(WDFiles)){
  mydata <- read.csv(WDFiles[pNum])
...
data.locomotion.furniture.recall <- data.frame( 
  PID = 1:16,
  Furniture = rep(c("Furniture", "NoFurniture"), each = 16),
  Rotation = c(get('MeanFurnitureRotation 1'),  get('MeanFurnitureRotation 2'), get('MeanFurnitureRotation 3'), get('MeanFurnitureRotation 4'), 
                 get('MeanFurnitureRotation 5'), get('MeanFurnitureRotation 6'), get('MeanFurnitureRotation 7'), get('MeanFurnitureRotation 8'), 
...
data.locomotion.furniture.recall$PID=as.factor(data.locomotion.furniture.recall$PID)
data.locomotion.furniture.recall$Furniture=as.factor(data.locomotion.furniture.recall$Furniture)


setwd("~/R Projects/ARSpatialMemory-R")
save(data.locomotion.furniture.recall, file = "data.locomotion.furniture.recall.Rdata")


##################################################
######### Locomotion by Layout (Learning) #######################
setwd("~/R Projects/ARSpatialMemory-R/Data/positionData")
WDFiles = list.files(pattern="*Raw.csv")
for(pNum in 1:length(WDFiles)){
  mydata <- read.csv(WDFiles[pNum])
