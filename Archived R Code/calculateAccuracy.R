...
################################# Data Analysis ###################################
### testing normality
shapiro.test(finishedDF$Accuracy) # p-value = 0.002458, not normally distributed
shapiro.test(finishedDF$Accuracy_Modif) # p-value = 0.03012, not normally distributed
shapiro.test(finishedDF$EuclideanError) # p-value = 0.1704, normally distributed
